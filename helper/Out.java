package helper; /*************************************************************************
 *  Compilation:  javac Helper.Out.java
 *  Execution:    java Helper.Out
 *
...
public class Out {
    ...
    // assume language = English, country = US for consistency with Helper.In
    private static final Locale LOCALE = Locale.US;

    private PrintWriter out;

   /**
     * Create an Helper.Out object using an OutputStream.
     */
   ...
   /**
     * Create an Helper.Out object using standard output.
     */
    public Out() { this(System.out); }

   /**
     * Create an Helper.Out object using a Socket.
     */
   ...
   /**
     * Create an Helper.Out object using a file specified by the given name.
     */
    public Out(String s) {
        try {
