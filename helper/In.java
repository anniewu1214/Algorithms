package helper; /*************************************************************************
 * Compilation:  javac Helper.In.java
 * Execution:    java Helper.In   (basic test --- see source for required files)
 * <p/>
...
public final class In {
    ...
    /*** begin: section (1 of 2) of code duplicated from Helper.In to StdIn */
    ...
    /*** end: section (1 of 2) of code duplicated from Helper.In to StdIn */
    ...
    /*** begin: section (2 of 2) of code duplicated from Helper.In to StdIn,
    ...
    public char readChar() {
        ...
        assert (ch.length() == 1) : "Internal (Std)Helper.In.readChar() error!"
    ...
    /*** end: section (2 of 2) of code duplicated from Helper.In to StdIn */
     ...
     * <tt>new Helper.In(filename)</tt>.{@link #readAllInts()}
     */
     ...
     * @deprecated Clearer to use 
     * <tt>new Helper.In(filename)</tt>.{@link #readAllDoubles()}
     */
     ...
     * @deprecated Clearer to use 
     * <tt>new Helper.In(filename)</tt>.{@link #readAllStrings()}
     */
    ...
    /**
     * A generic bag or mutiset, implemented using a singly-linked list.
     * <p>
     ...
     * then to iterate through the collection items.</p>
     */
